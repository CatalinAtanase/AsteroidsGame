...
// verifica coliziune racheta -> asteroid
...
// verifica coliziune nava -> asteroid
...
const setAsteroidSpeed = (asteroid) => {
  asteroid.xSpeed = Math.min(1, asteroidXSpeed * (ASTEROID_MAX_HP - asteroid.hp + 1));
  asteroid.ySpeed = Math.min(1, asteroidYSpeed * (ASTEROID_MAX_HP - asteroid.hp + 1));
};
